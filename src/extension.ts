                        ...
                        case 'save':
                            if (activeDocumentUri) {
                                try {
                                    ...
                                    const doc = await vscode.workspace.openTextDocument(activeDocumentUri);
